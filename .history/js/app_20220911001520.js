...
$(".silder-poster").slick({
  ...
  arrows: true,
  prevArrow:
    '<span class="prev-arrow slider-poster-arr"><i class="fa-solid fa-angle-left"></i></span>',
  nextArrow:
    '<span class="next-arrow slider-poster-arr"><i class="fa-solid fa-angle-right"></i></span>',
});
// Sidebar menu toggle
