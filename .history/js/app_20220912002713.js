...
const listSelectionItem = document.querySelectorAll(
  ".slider-search__option-name"
);
...
listSelectionItem.forEach((item) =>
  item.addEventListener("click", function (e) {
    listSelectionItem.forEach((item) => (item.style.color = "#848484"));
    setTimeout(() => {
      listSelectionItem.forEach((item) => (item.style.color = "unset"));
    }, 500);
...
//   e.preventDefault();
//   if (e.target.dataset.dateSelect === "date") {
//     e.target.nextElementSibling.classList.toggle("is-show");
//   } else if (e.target.dataset.travelSelect === "travel") {
//     e.target.nextElementSibling.classList.toggle("is-show");
//   }
// }
// window.addEventListener("click", function (e) {
