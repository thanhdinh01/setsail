...
const toggleMenuItem = document.querySelectorAll(".navbar__mobile-list li");
...
toggleMenuItem.forEach((item) =>
  item.addEventListener("click", function (e) {
    ...
    e.target.querySelector(">span").classList.toggle("rotated");
    // e.target.lastElementChild.classList.toggle("is-show");
  })
);
