...
selectName.forEach(item=> item.addEventListener("click", handleListSelection))
const handleListSelection= function (e) {
  console.log(e.target);
  e.preventDefault();
  listSelection.classList.toggle("is-show");
});
window.addEventListener("click", function (e) {
  if (listSelection.contains(e.target) && e.target !== selectName) {
    console.log("oke");
  }
});
